...
> = {
  ...
  bill_transaction: { label: "BT Attributes", icon: "receipt", color: "#7c3aed" },
};
...
export const SPLITTABLE_ATTRIBUTES = [
  ...
  // ── BT Attributes (Bill Transaction line-item level) ──
  { key: "bt.brand_name", label: "BT Brand Name" },
  { key: "bt.segment_desc", label: "BT Product Segment" },
  { key: "bt.family_desc", label: "BT Product Family" },
  { key: "bt.class_desc", label: "BT Product Class" },
  { key: "bt.delivery_channel", label: "BT Channel (Online/Store)" },
  { key: "bt.store_format", label: "BT Store Format" },
  { key: "bt.city", label: "BT Transaction City" },
  { key: "bt.region", label: "BT Transaction Region" },
  { key: "bt.day_of_week", label: "BT Day of Week" },
];
