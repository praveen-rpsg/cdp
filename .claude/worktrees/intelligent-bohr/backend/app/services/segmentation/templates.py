...
TEMPLATES: list[SegmentTemplate] = [
    ...
    # ── BT-Powered Templates ──
    SegmentTemplate(
        id="bt-dairy-buyers",
        name="Dairy Product Buyers",
        description="Customers who purchased dairy products (from bill transaction line items)",
        category="product_affinity",
        applicable_brands=["spencers"],
        business_function="marketing",
        rules=SegmentDefinition(root=_grp("and",
            _attr("bt.family_desc", "contains", "Dairy"),
        )),
    ),
    SegmentTemplate(
        id="bt-high-value-transactions",
        name="High-Value Bill Transactions",
        description="Customers with at least one line item grossing over ₹2000",
        category="transactional",
        applicable_brands=["spencers"],
        business_function="analytics",
        rules=SegmentDefinition(root=_grp("and",
            _attr("bt.gross_sale_value", "greater_than", 2000),
        )),
    ),
    SegmentTemplate(
        id="bt-brand-buyers",
        name="Specific Brand Buyers",
        description="Customers who purchased a specific brand — customize the brand name",
        category="product_affinity",
        applicable_brands=["spencers"],
        business_function="marketing",
        rules=SegmentDefinition(root=_grp("and",
            _attr("bt.brand_name", "equals", "Amul"),
        )),
    ),
    SegmentTemplate(
        id="bt-online-shoppers",
        name="Online Bill Shoppers",
        description="Customers with at least one online bill transaction (delivery channel = Online)",
        category="channel",
        applicable_brands=["spencers"],
        business_function="marketing",
        rules=SegmentDefinition(root=_grp("and",
            _attr("bt.delivery_channel", "equals", "Online"),
        )),
    ),
