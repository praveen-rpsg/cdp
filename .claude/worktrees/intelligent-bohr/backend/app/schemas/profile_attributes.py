...
ATTRIBUTE_CATALOG: list[AttributeDefinition] = [
    ...
    AttributeDefinition(
        ...
        operators=STRING_OPS,
        example_values=["Amul", "Britannia", "Tata", "ITC", "Nestle"],
        applicable_brands=["spencers"],
        source_table="s_fact_bill_transactions",
    ),
    AttributeDefinition(
        ...
        operators=STRING_OPS,
        example_values=["Food", "Non Food", "FMCG", "Staples"],
        applicable_brands=["spencers"],
        source_table="s_fact_bill_transactions",
    ),
    AttributeDefinition(
        ...
        operators=STRING_OPS,
        example_values=["Dairy", "Beverages", "Snacks", "Personal Care"],
        applicable_brands=["spencers"],
        source_table="s_fact_bill_transactions",
    ),
    AttributeDefinition(
        ...
        operators=STRING_OPS,
        example_values=["Milk", "Biscuits", "Soft Drinks"],
        applicable_brands=["spencers"],
        source_table="s_fact_bill_transactions",
    ),
    AttributeDefinition(
        ...
        operators=STRING_OPS,
        example_values=["Full Cream Milk", "Cream Biscuits"],
        applicable_brands=["spencers"],
        source_table="s_fact_bill_transactions",
    ),
    AttributeDefinition(
        ...
        operators=STRING_OPS,
        example_values=["Amul Taaza 500ml", "Britannia Good Day 150g"],
        applicable_brands=["spencers"],
        source_table="s_fact_bill_transactions",
    ),
    AttributeDefinition(
    ...
    AttributeDefinition(
        ...
        operators=STRING_OPS,
        example_values=["Hindustan Unilever", "P&G", "Dabur"],
        applicable_brands=["spencers"],
        source_table="s_fact_bill_transactions",
    ),
    AttributeDefinition(
