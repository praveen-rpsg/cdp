{{ config(
    ...
    schema='silver',
    post_hook=[
        "CREATE INDEX IF NOT EXISTS idx_sfbt_mobile ON {{ this }}(mobile_number)",
        "CREATE INDEX IF NOT EXISTS idx_sfbt_store ON {{ this }}(store_code)",
        "CREATE INDEX IF NOT EXISTS idx_sfbt_article ON {{ this }}(article)",
        "CREATE INDEX IF NOT EXISTS idx_sfbt_date ON {{ this }}(bill_date)",
        "CREATE INDEX IF NOT EXISTS idx_sfbt_brand ON {{ this }}(brand_name)",
        "CREATE INDEX IF NOT EXISTS idx_sfbt_family ON {{ this }}(family_desc)",
    ]
) }}
