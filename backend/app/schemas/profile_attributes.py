...
ATTRIBUTE_CATALOG: list[AttributeDefinition] = [
    ...
    AttributeDefinition(
        ...
        operators=STRING_OPS,
        example_values=["FOOD", "NON FOOD GROCERY", "NON TRADE", "LIFESTYLE"],
        applicable_brands=["spencers"],
        source_table="s_fact_bill_transactions",
    ),
    AttributeDefinition(
        ...
        operators=STRING_OPS,
        example_values=["PROCESSED FOOD", "HEALTH & BEAUTY", "BEVERAGES", "HOUSE HOLD NEED"],
        applicable_brands=["spencers"],
        source_table="s_fact_bill_transactions",
    ),
    AttributeDefinition(
        ...
        operators=STRING_OPS,
        example_values=["BISCUIT", "DAIRY", "CONFECTIONARY", "LAUNDRY", "EDIBLE OIL", "AUDIO"],
        applicable_brands=["spencers"],
        source_table="s_fact_bill_transactions",
    ),
    AttributeDefinition(
        ...
        operators=STRING_OPS,
        example_values=["PULSES", "FLOUR", "CREAM BISCUITS", "FABRIC WASH"],
        applicable_brands=["spencers"],
        source_table="s_fact_bill_transactions",
    ),
    AttributeDefinition(
