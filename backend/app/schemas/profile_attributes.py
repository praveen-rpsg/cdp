...
ATTRIBUTE_CATALOG: list[AttributeDefinition] = [
    ...
    # =========================================================================
    # PROPENSITY / SEGMENT AFFINITY  (table: customer_propensity_scores)
    # Pre-computed LightGBM scores per product segment.
    # Raw scores: independent binary model outputs (0–1).
    # Normalized scores: raw / sum(raw), sum to 1 per customer.
    # =========================================================================

    # ── Spencer's propensity scores ──────────────────────────────────────────
    AttributeDefinition(
        key="affinity.spencers_fashion_cb_propensity",
        label="Fashion CB Propensity (Raw)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Raw LightGBM propensity score for the Fashion CB segment (0–1)",
        operators=NUMERIC_OPS,
        example_values=[0.12, 0.45, 0.78],
        applicable_brands=["spencers"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ),
    AttributeDefinition(
        key="affinity.spencers_food_propensity",
        label="Food Propensity (Raw)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Raw LightGBM propensity score for the Food segment (0–1)",
        operators=NUMERIC_OPS,
        example_values=[0.20, 0.55, 0.90],
        applicable_brands=["spencers"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    AttributeDefinition(
        key="affinity.spencers_gm_propensity",
        label="GM Propensity (Raw)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Raw LightGBM propensity score for the General Merchandise segment (0–1)",
        operators=NUMERIC_OPS,
        example_values=[0.10, 0.35, 0.65],
        applicable_brands=["spencers"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    AttributeDefinition(
        key="affinity.spencers_hi_tech_propensity",
        label="Hi-Tech Propensity (Raw)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Raw LightGBM propensity score for the Hi-Tech segment (0–1)",
        operators=NUMERIC_OPS,
        example_values=[0.05, 0.22, 0.50],
        applicable_brands=["spencers"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    AttributeDefinition(
        key="affinity.spencers_non_trade_propensity",
        label="Non Trade Propensity (Raw)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Raw LightGBM propensity score for the Non Trade segment (0–1)",
        operators=NUMERIC_OPS,
        example_values=[0.08, 0.30, 0.60],
        applicable_brands=["spencers"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    AttributeDefinition(
        key="affinity.spencers_non_food_grocery_propensity",
        label="Non Food Grocery Propensity (Raw)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Raw LightGBM propensity score for the Non Food Grocery segment (0–1)",
        operators=NUMERIC_OPS,
        example_values=[0.15, 0.40, 0.72],
        applicable_brands=["spencers"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    AttributeDefinition(
        key="affinity.spencers_fashion_cb_propensity_normalized",
        label="Fashion CB Propensity (Normalized)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Normalized propensity for Fashion CB — share of total affinity (sums to 1)",
        operators=NUMERIC_OPS,
        example_values=[0.05, 0.18, 0.35],
        applicable_brands=["spencers"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    AttributeDefinition(
        key="affinity.spencers_food_propensity_normalized",
        label="Food Propensity (Normalized)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Normalized propensity for Food — share of total affinity (sums to 1)",
        operators=NUMERIC_OPS,
        example_values=[0.10, 0.28, 0.45],
        applicable_brands=["spencers"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    AttributeDefinition(
        key="affinity.spencers_gm_propensity_normalized",
        label="GM Propensity (Normalized)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Normalized propensity for GM — share of total affinity (sums to 1)",
        operators=NUMERIC_OPS,
        example_values=[0.05, 0.15, 0.30],
        applicable_brands=["spencers"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    AttributeDefinition(
        key="affinity.spencers_hi_tech_propensity_normalized",
        label="Hi-Tech Propensity (Normalized)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Normalized propensity for Hi-Tech — share of total affinity (sums to 1)",
        operators=NUMERIC_OPS,
        example_values=[0.02, 0.10, 0.25],
        applicable_brands=["spencers"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    AttributeDefinition(
        key="affinity.spencers_non_trade_propensity_normalized",
        label="Non Trade Propensity (Normalized)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Normalized propensity for Non Trade — share of total affinity (sums to 1)",
        operators=NUMERIC_OPS,
        example_values=[0.04, 0.12, 0.22],
        applicable_brands=["spencers"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    AttributeDefinition(
        key="affinity.spencers_non_food_grocery_propensity_normalized",
        label="Non Food Grocery Propensity (Normalized)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Normalized propensity for Non Food Grocery — share of total affinity (sums to 1)",
        operators=NUMERIC_OPS,
        example_values=[0.06, 0.17, 0.32],
        applicable_brands=["spencers"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    # ── NBL propensity scores ─────────────────────────────────────────────────
    AttributeDefinition(
        key="affinity.nbl_food_propensity",
        label="Food Propensity (Raw)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Raw LightGBM propensity score for the NBL Food segment (0–1)",
        operators=NUMERIC_OPS,
        example_values=[0.25, 0.60, 0.88],
    ...
    AttributeDefinition(
        key="affinity.nbl_gm_propensity",
        label="GM Propensity (Raw)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Raw LightGBM propensity score for the NBL GM segment (0–1)",
        operators=NUMERIC_OPS,
        example_values=[0.10, 0.35, 0.62],
        applicable_brands=["natures_basket"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    AttributeDefinition(
        key="affinity.nbl_non_trade_propensity",
        label="Non Trade Propensity (Raw)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Raw LightGBM propensity score for the NBL Non Trade segment (0–1)",
        operators=NUMERIC_OPS,
        example_values=[0.08, 0.28, 0.55],
        applicable_brands=["natures_basket"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    AttributeDefinition(
        key="affinity.nbl_non_food_grocery_propensity",
        label="Non Food Grocery Propensity (Raw)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Raw LightGBM propensity score for the NBL Non Food Grocery segment (0–1)",
        operators=NUMERIC_OPS,
        example_values=[0.12, 0.38, 0.68],
        applicable_brands=["natures_basket"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    # Normalized scores
    AttributeDefinition(
        key="affinity.nbl_food_propensity_normalized",
        label="Food Propensity (Normalized)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Normalized propensity for NBL Food — share of total affinity (sums to 1)",
        operators=NUMERIC_OPS,
        example_values=[0.15, 0.35, 0.55],
        applicable_brands=["natures_basket"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    AttributeDefinition(
        key="affinity.nbl_gm_propensity_normalized",
        label="GM Propensity (Normalized)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Normalized propensity for NBL GM — share of total affinity (sums to 1)",
        operators=NUMERIC_OPS,
        example_values=[0.08, 0.22, 0.40],
        applicable_brands=["natures_basket"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    AttributeDefinition(
        key="affinity.nbl_non_trade_propensity_normalized",
        label="Non Trade Propensity (Normalized)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Normalized propensity for NBL Non Trade — share of total affinity (sums to 1)",
        operators=NUMERIC_OPS,
        example_values=[0.05, 0.18, 0.30],
        applicable_brands=["natures_basket"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    AttributeDefinition(
        key="affinity.nbl_non_food_grocery_propensity_normalized",
        label="Non Food Grocery Propensity (Normalized)",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Normalized propensity for NBL Non Food Grocery — share of total affinity (sums to 1)",
        operators=NUMERIC_OPS,
        example_values=[0.08, 0.25, 0.42],
        applicable_brands=["natures_basket"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    AttributeDefinition(
        key="affinity.spencers_dominant_segment",
        label="Dominant Affinity Segment",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.STRING,
        description="The product segment with the highest normalized propensity for this customer.",
        operators=["in_list", "not_in_list", "exists", "not_exists"],
        example_values=["FASHION CB", "FOOD", "GM", "HI TECH", "NON TRADE", "NON FOOD GROCERY"],
        applicable_brands=["spencers"],
        is_computed=True,
        # No source_table — fixed label set; static dropdown via example_values.
    ),
    AttributeDefinition(
        key="affinity.spencers_dominant_segment_score",
        label="Dominant Affinity Score",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Normalized propensity of the customer's dominant product segment.",
        operators=NUMERIC_OPS,
        example_values=[0.25, 0.40, 0.65],
        applicable_brands=["spencers"],
        is_computed=True,
        unit="score",
        source_table="customer_propensity_scores",
    ...
    AttributeDefinition(
        key="affinity.nbl_dominant_segment",
        label="Dominant Affinity Segment",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.STRING,
        description="The product segment with the highest normalized propensity for this customer.",
        operators=["in_list", "not_in_list", "exists", "not_exists"],
        example_values=["FOOD", "GM", "NON TRADE", "NON FOOD GROCERY"],
        applicable_brands=["natures_basket"],
        is_computed=True,
        # No source_table — fixed label set; static dropdown via example_values.
    ),
    AttributeDefinition(
        key="affinity.nbl_dominant_segment_score",
        label="Dominant Affinity Score",
        category=AttributeCategory.PRODUCT_AFFINITY,
        data_type=AttributeDataType.FLOAT,
        description="Normalized propensity of the customer's dominant product segment.",
    ...
    AttributeDefinition(
        ...
        data_type=AttributeDataType.STRING,
        description=(
            "Brands this customer is registered with across RPSG. "
            "Select 'Spencer's', 'NBL', or 'CESC' from the dropdown. "
            "Uses a substring match internally against the stored brand list."
        ),
        operators=["in_list", "not_in_list", "exists", "not_exists"],
        example_values=["Spencer", "NBL", "CESC", "Saregama", "DrVaidyas", "Sports", "Naturali", "NPCL"],
        applicable_brands=["corporate"],
        # No source_table — values are a fixed set; use example_values as the static dropdown.
    ),
    AttributeDefinition(
        key="corp.rpsg_ftd",
