...
ATTRIBUTE_CATALOG: list[AttributeDefinition] = [
    ...
    AttributeDefinition(
        ...
        applicable_brands=["spencers", "nbl"],
        source_table="unified_profiles",
    ),
    AttributeDefinition(
    ...
    AttributeDefinition(
        ...
        category=AttributeCategory.LIFECYCLE,
        data_type=AttributeDataType.STRING,
        description="Level-2 behavioral segment — currently computed values: Inactive, LAPSER",
        operators=STRING_OPS,
        example_values=["Inactive", "LAPSER"],
        applicable_brands=["spencers", "nbl"],
        is_computed=True,
        source_table="customer_behavioral_attributes",
    ),
    AttributeDefinition(
        ...
        category=AttributeCategory.LIFECYCLE,
        data_type=AttributeDataType.STRING,
        description="Customer lifecycle stage — currently computed values: At Risk, Lapsed, Registered",
        operators=STRING_OPS,
        example_values=["At Risk", "Lapsed", "Registered"],
        applicable_brands=["spencers", "nbl"],
        is_computed=True,
        source_table="customer_behavioral_attributes",
    ),
    ...
    AttributeDefinition(
        ...
        category=AttributeCategory.BILL_TRANSACTION,
        data_type=AttributeDataType.STRING,
        description="Most granular product hierarchy level (brick)",
        operators=STRING_OPS,
        example_values=["WHOLE SPICE", "STRAIGHT SPICE PWDR", "WHISKY", "LOCAL NAMKEEN", "REPACK COVERS", "PULSES"],
        applicable_brands=["spencers", "nbl"],
        source_table="s_fact_bill_transactions",
    ),
    AttributeDefinition(
        ...
        category=AttributeCategory.BILL_TRANSACTION,
        data_type=AttributeDataType.STRING,
        description="Specific article or SKU description purchased",
        operators=STRING_OPS,
        example_values=["AMUL TAAZA 500ML", "TATA SALT 1KG", "SURF EXCEL 1KG"],
        applicable_brands=["spencers", "nbl"],
        source_table="s_fact_bill_transactions",
    ),
    AttributeDefinition(
    ...
    AttributeDefinition(
        ...
        category=AttributeCategory.BILL_TRANSACTION,
        data_type=AttributeDataType.STRING,
        description="City where the bill transaction occurred",
        operators=STRING_OPS,
